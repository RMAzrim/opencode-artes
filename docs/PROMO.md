# 🎉 Promo Kit — opencode-artes

Post-ready copy for announcing the repository. Copy-paste, adapt, publish. Every share counts — please link to <https://github.com/RMAzrim/opencode-artes> and ask people to ⭐.

---

## 📢 GitHub Release / Release Notes (short)

> **opencode-artes v4.0.0 is here — 115 production-grade OpenCode skills in one repo, with a curated 🔥 25 Must-Have Skills showcase.**
>
...
>
> - ⚡ One-line install: add the HTTP catalog URL to `opencode.jsonc` and restart
> - 🧩 Slash commands (`/security-suite-orchestrator`) + natural-language discovery
> - 🔐 Local `+` local-only security auditing (CVE, SAST, SQLi/XSS, JWT, IDOR/BOLA, rate-limit, headers)
> - ✅ CI-gated: every PR is verified (build, frontmatter contract, reproducibility)
> - 🌐 Live catalog: https://rmazrim.github.io/opencode-artes/
>
> Star it if it helps: https://github.com/RMAzrim/opencode-artes ⭐
...
>
> Every skill has a complete, runnable reference implementation and a strict 5-section contract. The repo is CI-gated (build + frontmatter + reproducibility checks) and publishes a live catalog site.
>
> Try it: https://github.com/RMAzrim/opencode-artes — stars and issues welcome.
...
>
> Install: one line in `opencode.jsonc` (HTTP catalog) or clone + `npm run build`. Live catalog: https://rmazrim.github.io/opencode-artes/
>
> Feedback, bug reports, and feature requests welcome — and a star always helps. :)
...
>
> Links:
> - Repo &rarr; https://github.com/RMAzrim/opencode-artes
> - Live catalog &rarr; https://rmazrim.github.io/opencode-artes/
> - Install &rarr; one line in `opencode.jsonc`: HTTP catalog URL, then restart OpenCode.

---

## ✍️ Attribution tips

- Always include the repo URL so GitHub's traffic data picks it up.
- A screenshot of the live catalog site (`docs/index.html`) makes posts perform better than text-only.
- Cross-post the same day as the release for compounding visibility.