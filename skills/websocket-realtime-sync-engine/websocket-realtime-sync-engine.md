---
id: websocket-realtime-sync-engine
file_path: skills/websocket-realtime-sync-engine/websocket-realtime-sync-engine.md
name: WebSocket Realtime Sync Engine
category: backend
tags: [websocket, sse, reconnection, backoff, heartbeat, sync]
