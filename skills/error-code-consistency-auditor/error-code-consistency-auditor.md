---
id: error-code-consistency-auditor
file_path: skills/error-code-consistency-auditor/error-code-consistency-auditor.md
name: Error Code Consistency Auditor
category: backend
tags: [errors, http-status, audit, consistency, api, observability]
