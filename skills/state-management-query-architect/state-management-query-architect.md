---
id: state-management-query-architect
file_path: skills/state-management-query-architect/state-management-query-architect.md
name: State Management & Query Architect
category: frontend
tags: [zustand, tanstack-query, state-management, server-state]
